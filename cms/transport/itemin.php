        ...
        <div id="itemTable">
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              if($pdname != '' && $ed1 != '' && $ed2 != '')
              {
                $sql = "SELECT * FROM inventory WHERE company = '".$_SESSION['company']."' AND product_name LIKE '%".$pdname."%' AND entry_date BETWEEN '".$ed1."' AND '".$ed2."' AND out_quantity = 0";
              }
              else if($pdname != '' && $ed1 == '' && $ed2 == '')
              {
                $sql = "SELECT * FROM inventory WHERE company = '".$_SESSION['company']."' AND product_name LIKE '%".$pdname."%' AND out_quantity = 0";
              }
              else if($pdname == '' && $ed1 != '' && $ed2 != '')
              {
                $sql = "SELECT * FROM inventory WHERE company = '".$_SESSION['company']."' AND entry_date BETWEEN '".$ed1."' AND '".$ed2."' AND out_quantity = 0";
              }
              else
              {
                $sql = "SELECT * FROM inventory WHERE company = '".$_SESSION['company']."' AND out_quantity = 0";
              }
            ...
            <tfoot>
              <tr>
                ...
                <th>
                  <?php
                  if(isset($_GET['pdname']) || isset($_GET['ed1']) || isset($_GET['ed2'])){
                    $sql = "SELECT COUNT(DISTINCT product_name) FROM inventory WHERE company = '".$_SESSION['company']."' AND product_name LIKE '%".$_GET['pdname']."%' AND entry_date BETWEEN '".$_GET['ed1']."' AND '".$_GET['ed2']."' AND out_quantity = 0";
                  }
                  else{
                    $sql = "SELECT COUNT(DISTINCT product_name) FROM inventory WHERE company = '".$_SESSION['company']."' AND out_quantity = 0";
                  }
                  $result = mysqli_query($conn, $sql);
                ...
                <th>
                  <?php
                  if(isset($_GET['pdname']) || isset($_GET['ed1']) || isset($_GET['ed2'])){
                    $sql = "SELECT SUM(in_quantity) FROM inventory WHERE company = '".$_SESSION['company']."' AND product_name LIKE '%".$_GET['pdname']."%' AND entry_date BETWEEN '".$_GET['ed1']."' AND '".$_GET['ed2']."' AND out_quantity = 0";
                  }
                  else{
                    $sql = "SELECT SUM(in_quantity) FROM inventory WHERE company = '".$_SESSION['company']."' AND out_quantity = 0";
                  }
                  $result = mysqli_query($conn, $sql);
                  $row = mysqli_fetch_assoc($result);
                ...
                <th>
                  <?php
                  if(isset($_GET['pdname']) || isset($_GET['ed1']) || isset($_GET['ed2'])){
                    $sql = "SELECT SUM(value) FROM inventory WHERE company = '".$_SESSION['company']."' AND product_name LIKE '%".$_GET['pdname']."%' AND entry_date BETWEEN '".$_GET['ed1']."' AND '".$_GET['ed2']."' AND out_quantity = 0";
                  }
                  else{
                    $sql = "SELECT SUM(value) FROM inventory WHERE company = '".$_SESSION['company']."' AND out_quantity = 0";
                  }
                  $result = mysqli_query($conn, $sql);
                  $row = mysqli_fetch_assoc($result);
                ...
                <th>
                  <?php
                  if(isset($_GET['pdname']) || isset($_GET['ed1']) || isset($_GET['ed2'])){
                    $sql = "SELECT COUNT(DISTINCT person_name) FROM inventory WHERE company = '".$_SESSION['company']."' AND product_name LIKE '%".$_GET['pdname']."%' AND entry_date BETWEEN '".$_GET['ed1']."' AND '".$_GET['ed2']."' AND out_quantity = 0";
                  }
                  else{
                    $sql = "SELECT COUNT(DISTINCT person_name) FROM inventory WHERE company = '".$_SESSION['company']."' AND out_quantity = 0";
                  }
                  $result = mysqli_query($conn, $sql);
                  $row = mysqli_fetch_assoc($result);
